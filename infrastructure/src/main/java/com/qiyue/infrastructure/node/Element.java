package com.qiyue.infrastructure.node;
...
public class Element<E> {
    ...
    public static <E> Element<E> convert(E source, String nodeId, String superNodeId) {
        if (null == source) {
            throw new LogicException(ExceptionEnum.ELEMENT_NOT_NULL_DATA);
        }
        if (null == nodeId) {
            throw new LogicException(ExceptionEnum.ELEMENT_NOT_NULL_NODE_ID);
        }
