package com.qiyue.standard.enums;
...
public enum ExceptionEnum {
     ...
     * 捕获编译时异常，包装抛出
     */
    QSG_CATCH_EXCEPTION("QGS_CATCH_000001", "捕获异常"),
    /**
     * 登录
     */
     ...
     * 参数检验 param verify
     */
    QBG_ASSERT_OBJECT_NON_NULL("QGB_ASSERT_000001", "参数不能为空"),
    QBG_ASSERT_COLLECTION_NOT_EMPTY("QGB_ASSERT_000002", "集合不能为空"),
    QBG_ASSERT_VALUE_NOT_IN("QGB_ASSERT_000003", "值不在集合中"),
    QBG_ASSERT_EXPRESSION_COME_OUT_FALSE("QGB_ASSERT_000004", "表达式结果为false"),
    QBG_ASSERT_ENUM_NOT_EXISTS("QGB_ASSERT_000005", "枚举中不存在目标值"),
    /**
     *
     *  数据库数据异常
     */
