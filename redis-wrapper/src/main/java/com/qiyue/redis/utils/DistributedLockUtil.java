...
public class DistributedLockUtil {
    ...
    public static final long TIMEOUT_DEFAULT = 3000L;
    public static final TimeUnit TIME_UNIT_DEFAULT = TimeUnit.MILLISECONDS;
    public static final TimeoutRetryPolicy TIMEOUT_RETRY_POLICY;
    ...
    public static TimeoutRetryPolicy createTimeoutRetry() {
        return createTimeoutRetry(TIMEOUT_DEFAULT, TIME_UNIT_DEFAULT);
    }

    public static final int MAX_ATTEMPTS = 100;
    public static final MaxAttemptsRetryPolicy MAX_ATTEMPTS_RETRY_POLICY;
    ...
    public static final FixedBackOffPolicy FIXED_BACK_OFF_POLICY;
    ...
    public static final RetryTemplate LOCK_RETRY_TEMPLATE;
    public static final RetryTemplate UNLOCK_RETRY_TEMPLATE;
    ...
    static {
        ...
        LOCK_RETRY_TEMPLATE = RETRY_TEMPLATE_BUILDER.customPolicy(compositeRetryPolicy)
                .customBackoff(FIXED_BACK_OFF_POLICY)
                .retryOn(IllegalStateException.class).build();
        UNLOCK_RETRY_TEMPLATE = RETRY_TEMPLATE_BUILDER.customPolicy(compositeRetryPolicy)
                .customBackoff(createExponentialBackOff())
                .build();
    }
    ...
    public static boolean lock(String key) {
        ...
        return lock(key, tag, LOCK_RETRY_TEMPLATE);
    }
    ...
    public static boolean unlock(String key) {
        String tag = String.valueOf(Thread.currentThread().getId());
        return unlock(key, tag, UNLOCK_RETRY_TEMPLATE);
    }
